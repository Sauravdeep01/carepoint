          ...
          appointments.map((item, index) => (
            ...
            >
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-zinc-500 mb-1'>{item.docData.speciality}</p>
                ...
                {!item.cancelled && !item.payment && !item.isCompleted && (
                  <>
                    ...
                    <button
                      ...
                      className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border border-zinc-200 rounded hover:bg-red-600 hover:text-white transition-all duration-300'
                    >
                      Cancel appointment
                    </button>
                  </>
